...
import { URL_API, URL_APIU, URL_IMAGES } from "../config/rutas";
...
export function EditarUsuario(){
    ...
    useEffect(() => {
        async function buscarPorID() {
                const res = await axios.get(URL_APIU+"buscarUsuarioPorId/" + params.id);
                setId(res.data.id);
    ...
    async function editarUsuario(e) {
        e.preventDefault();
            ...
            const res = await axios.post(URL_APIU+"editarUsuario", formData, {
                headers: {
